...
void AppScreen::OnButtonAReleased() {
  if(centreWidget != nullptr)
    centreWidget->OnButtonAReleased();
}
...
void AppScreen::OnButtonBReleased() {
  if(centreWidget != nullptr)
    centreWidget->OnButtonBReleased();
}
...
void AppScreen::OnButtonCReleased() {
  if(centreWidget != nullptr)
    centreWidget->OnButtonCReleased();
}
